...
import mlflow
import dagshub
dagshub.init(repo_owner='Priyanshuc26', repo_name='NetworkSecurity-Project', mlflow=True)
...
class ModelTrainer:
    ...
    def train_model(self, x_train, y_train, x_test, y_test):
        ...
        ## Tracking mlflow
        self.track_mlflow(best_model, classification_train_metric) #To track it by susing UI, write mlflow ui on terminal
